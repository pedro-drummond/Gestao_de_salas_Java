...
public class TelaCadastrarSala extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        codigo.setBackground(new java.awt.Color(110, 110, 110));
        ...
        capacidade.setBackground(new java.awt.Color(110, 110, 110));
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        ...
        if(cadastrar.isEnabled()){
            Colecao salas = Colecao.getInstancia();
            Sala e = getInfoSala();
                
            if (codigo.getText().equals("") || capacidade.getText().equals("")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastrarSala.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public Sala getInfoSala(){
        ...
        Sala aux = new Sala(codigo, capacidade);
        //falta o curso
        return aux;
    }
